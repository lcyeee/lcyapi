...
CREATE TABLE IF NOT EXISTS users (
    ...
    quota DECIMAL(12,4) NOT NULL DEFAULT 0.0000,
    used_quota DECIMAL(12,4) NOT NULL DEFAULT 0.0000,
    total_quota DECIMAL(12,4) NOT NULL DEFAULT 0.0000,
...
CREATE TABLE IF NOT EXISTS tokens (
    ...
    remain_quota DECIMAL(12,4) NOT NULL DEFAULT -1.0000,
    used_quota DECIMAL(12,4) NOT NULL DEFAULT 0.0000,
    status TINYINT NOT NULL DEFAULT 1,
