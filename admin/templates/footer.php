    ...
    <nav class="admin-tabbar">
        ...
        <a class="<?php echo admin_nav('/admin/groups/', $requestPath); ?>" href="<?php echo base_url('admin/groups/index.php'); ?>"><?php echo svg_icon('ratio'); ?>分组</a>
        ...
        <a class="<?php echo admin_nav('/admin/login-logs/', $requestPath); ?>" href="<?php echo base_url('admin/login-logs/index.php'); ?>"><?php echo svg_icon('check'); ?>登录</a>
